...
console.log("Read message 0: " + readMessages.has(messages[0])); // true, так как мы прочитали его выше

messages.shift(); // тут будет 2 элемента, так первый прочитали и удалили.
...
readMap.set(messagesPeople[0], new Date(2023, 3, 1));